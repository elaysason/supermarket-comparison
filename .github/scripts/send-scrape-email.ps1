...
<html>
  <body style="margin:0;background:#f6f8fb;color:#172033;font-family:Segoe UI,Arial,sans-serif;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f6f8fb;padding:24px 0;">
      <tr>
        <td align="center">
          <table role="presentation" width="720" cellspacing="0" cellpadding="0" style="width:720px;max-width:94%;background:#ffffff;border:1px solid #d9e2ec;border-radius:14px;overflow:hidden;">
            <tr>
            ...
            <tr>
              <td style="padding:24px 28px;">
                ...
                <pre style="white-space:pre-wrap;background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:14px;color:#172033;font-size:13px;line-height:1.45;">$encodedSummary</pre>

                <h2 style="font-size:16px;margin:24px 0 10px;color:#0f172a;">Last scraper log lines</h2>
                <pre style="white-space:pre-wrap;background:#0b1220;border-radius:10px;padding:14px;color:#dbeafe;font-size:12px;line-height:1.45;overflow:auto;">$encodedLog</pre>
              </td>
            </tr>
          </table>
        </td>
